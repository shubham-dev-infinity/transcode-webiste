...
import efficacy from "@public/Assets/efficacy2.png"
import data from "@public/Assets/data2.png"
import rating from "@public/Assets/rating1.png"
import discount from "@public/Assets/discount1.png"
import agile from "@public/Assets/agile1.png"
import Maskgroup from "@public/Assets/Maskgroup.png"
import people from "@public/Assets/people1.png"
import customize from "@public/Assets/customize.png"
import method from "@public/Assets/method.png"
const integration = () => {
        ...
        <main>
            ...
            <div className="container mx-auto px-4 mt-16">
                ...
                <div className="grid grid-cols-12 gap-5 mt-8">
                    <div className="col-span-12 md:col-span-6 p-12 text-left">
                        <h2 className="font-extrabold text-3xl">
                            Why should you select our system integration services
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="col-span-12 md:col-span-4  p-4">
                                <div className="col-span-4 flex gap-10 pt-4">
