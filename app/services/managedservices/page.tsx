                    ...
                    <div className="col-span-12 lg:col-span-6 p-12 text-left">
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-6 mb-4">
                            ...
                            <div className="col-span-9">
                                <h4 className="text-2xl font-extrabold text-blue">Network Management</h4>
                                <p className="text-base text-gray">We monitor and ensure optimal network performance and security.</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-6 mb-4">
                            <div className="col-span-3">
                            ...
                            <div className="col-span-9">
                                <h4 className="text-2xl font-extrabold text-blue">Infrastructure Management</h4>
                                <p className="text-base text-gray">We maintain servers, desktops, and other devices</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-6 mb-4">
                            <div className="col-span-3">
                            ...
                            <div className="col-span-9">
                                <h4 className="text-2xl font-extrabold text-blue">Security Management</h4>
                                <p className="text-base text-gray">We defend against cyber threats to secure datasystems and from threats posed by any devices on their network.</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-6 mb-4">
                            <div className="col-span-3">
                            ...
                            <div className="col-span-9">
                                <h4 className="text-2xl font-extrabold text-blue">Help Desk Support</h4>
                                <p className="text-base text-gray">When IT issues arise, our highly experienced ITsupport is there when needed. Patch management keeps software updated andsecure; backup and disaster recovery ensure your data remains safe; andstrategic IT consulting advises businesses on technology investments andstrategy.</p>
                            </div>
                        </div>
                    </div>             
                </div>
                <div className="mb-12">
                    <h2 className="text-2xl text-bule font-extrabold pb-4 text-blue">We offer customized engagement models designed to fit the specific needs, budget, and industry of each of our clients.</h2>
                    <div className="my-4">
                        <h3 className="font-extrabold text-blue text-xl pb-3">Full-Service Managed IT :</h3>
                        <p className="text-gray text-base">We take care of it all for you</p>
                    </div>
                    <div className="mb-4">
                        <h3 className="font-extrabold text-blue text-xl pb-3">Co-managed IT :</h3>
                        <p className="text-gray text-base">We work closely with your internal IT team.</p>
                    </div>
                    <div className="mb-4">
                        <h3 className="font-extrabold text-blue text-xl pb-3">Project-Based Services :</h3>
                        <p className="text-gray text-base">Our project-based services address specific ITrequirements or challenges.</p>
                    </div>
                    <div className="mb-4 ">
                        <h3 className="font-extrabold text-blue text-xl">Are you looking forward to experiencing the advantages of managed IT services?</h3>
                        <p className="text-gray text-base py-3">Reach out now for a complimentary consultation and see how we can assist:</p>
                    ...
                    <div className="mb-4">
                        <h3 className="font-extrabold text-blue text-xl">Bonus Tips :</h3>
                        <p className="text-gray text-base py-3">Cleanly present client testimonials as evidence of satisfaction with your services andcase studies that illustrate their impact. Offer free resources like whitepapers or webinars as additional ways of showing that people want them.</p>
