    ...
    return (
        <main className="mb-10">
            ...
            <div className="container mx-auto my-12">
                ...
                <div className="grid lg:grid-cols-1 xl:grid-cols-3 gap-4 mt-14 p-2">
                    {/* First Column */}
                    <div className={`${styles.gridItem} ${styles.missions} lg:p-6 xl:p-8`}>
                        <div className={styles.overlayText}>
                            <h2 className="font-semibold text-2xl mb-2">Missions</h2>
                            <p className="text-gray font-semibold text-xl text-center">Empower businesses with digital solutions to make their business processes more efficient. Bring utmost automation in software development lifecycle to have faster incremental software delivery with consistent quality.</p>
                        </div>
                    </div>
                    {/* Second Column */}
                    <div className={`${styles.gridItem} ${styles.coreValues} lg:p-6 xl:p-8`}>
                        <div className={styles.overlayText}>
                            <h2 className="font-semibold text-2xl mb-2">Core Values</h2>
                            <p className="text-gray font-semibold text-xl text-center">Creativity
                                Simplicity
                                Reliability
                                Out of box thinking
                                Quality</p>
                    ...
                    {/* Third Column */}
                    <div className={`${styles.gridItem} ${styles.vision} lg:p-6 xl:p-8`}>
                        <div className={styles.overlayText}>
                            <h2 className="font-semibold text-2xl mb-2">Vision</h2>
                            <p className="text-gray font-semibold text-xl text-center">To become a reliable technological partner that invents simpler solutions for complex problems.</p>
                        </div>
                    </div>
                </div>
