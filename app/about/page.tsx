            ...
            <div className="container mx-auto my-12">
                ...
                {/* <div className="bg-blue grid grid-cols-12">
                    ...
                    <div className="col-span-7 text-white pr-6">
                        ...
                        <p className="text-xl pt-6">Welcome to Transcodezy  Solutions, where we pour our hearts and souls into every project we undertake. We are a team of passionate individuals who believe in the power of technology to drive positive change. With each line of code we write, we strive to create solutions that not only meet but exceed our clients&apos; expectations. Our dedication to excellence is unwavering, as we work tirelessly to bring innovative ideas to life and make a lasting impact in the digital world.</p>
                        <p className="text-xl pt-6">At Transcodezy  Solutions, we are more than just an IT firm - we are dreamers, creators, and problem solvers. We take great pride in our ability to craft customized software services that empower businesses for success in today&apos;s fast-paced environment. Our journey is fueled by a shared vision of pushing boundaries, embracing challenges, and delivering tangible results that make a difference. Join us on this exciting adventure as we continue to innovate and transform the digital landscape together</p>
                    </div>
                </div> */}
                <div className="bg-blue grid grid-cols-12">
                    ...
                    <div className="col-span-12 p-2 lg:col-span-7 md:order-last text-white pr-6 sm:p-4">
                        ...
                        <p className="text-xl pt-6 xl:pt-3 xl:text-lg lg:text-base lg:pt-1 sm:text-base sm:pt-4">Welcome to Transcodezy  Solutions, where we pour our hearts and souls into every project we undertake. We are a team of passionate individuals who believe in the power of technology to drive positive change. With each line of code we write, we strive to create solutions that not only meet but exceed our clients&apos; expectations. Our dedication to excellence is unwavering, as we work tirelessly to bring innovative ideas to life and make a lasting impact in the digital world.</p>
                        <p className="text-xl pt-6 xl:pt-3 xl:text-lg lg:text-base lg:pt-1 sm:text-base sm:pt-4">At Transcodezy  Solutions, we are more than just an IT firm - we are dreamers, creators, and problem solvers. We take great pride in our ability to craft customized software services that empower businesses for success in today&apos;s fast-paced environment. Our journey is fueled by a shared vision of pushing boundaries, embracing challenges, and delivering tangible results that make a difference. Join us on this exciting adventure as we continue to innovate and transform the digital landscape together</p>
                    </div>
                </div>
