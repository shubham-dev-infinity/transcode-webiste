...
const ContactUs = () => {
    ...
    const validateAndSendEmail = () => {
        const { from_name, l_name, email_id, phone, message } = formData;
        if (!from_name || !l_name || !email_id || !phone || !message) {
    ...
    const sendEmail = () => {
        emailjs.send("service_6tboroy", "template_vzagmel", formData)
            .then((response) => {
                    ...
                    <div className="grid grid-cols-12 gap-4 mt-6">
                        ...
                        <div className="col-span-12 lg:col-span-8 bg-gray p-12 text-left">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                <div>
                                    <label className="block text-gray text-lg font-semibold mb-1">First Name</label>
                                    <input type="text" className="p-2 rounded-md w-full" name="from_name" value={formData.from_name} onChange={handleChange} />
                                </div>
                                <div>
                                    <label className="block text-gray text-lg font-semibold mb-1">Last Name</label>
                                    <input type="text" className="p-2 rounded-md w-full" name="l_name" value={formData.l_name} onChange={handleChange} />
                                </div>
                                <div>
                                    <label className="block text-gray text-lg font-semibold mb-1">Email</label>
                                    <input type="text" className="p-2 rounded-md w-full" name="email_id" value={formData.email_id} onChange={handleChange} />
                                </div>
                                <div>
                                    <label className="block text-gray text-lg font-semibold mb-1">Phone Number</label>
                                    <input type="text" className="p-2 rounded-md w-full" name="phone" value={formData.phone} onChange={handleChange} />
                                </div>
                                <div>
                                    <label className="block text-gray text-lg font-semibold mb-1">Message</label>
                                    <input type="text" className="p-2 rounded-md w-full" name="message" value={formData.message} onChange={handleChange} />
                                </div>
                                <div className="md:col-span-2 flex justify-center">
                                    <button className="bg-blue px-4 py-2 rounded-md text-white hover:bg-white hover:text-blue hover:border-blue border hover:border-solid" onClick={validateAndSendEmail}>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
