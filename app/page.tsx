          ...
          <div className="bg-gray">
            <div className="container mx-auto flex flex-col justify-center lg:pt-32">
              <div className="text-center pb-8">
                <h3 className="text-headertext text-xl sm:text-2xl font-extrabold pt-2">{slides[currentSlide].heading}</h3>
              ...
              <h4 className="text-black text-xl sm:text-2xl lg:text-5xl font-extrabold text-center mb-3">
                {slides[currentSlide].title1} <span className="text-headertext text-2xl sm:text-3xl lg:text-6xl font-extrabold text-center mb-3">{slides[currentSlide].title2}</span>{slides[currentSlide].title3}
              </h4>
              <h4 className="text-black text-2xl sm:text-3xl lg:text-6xl font-extrabold text-center mb-8">{slides[currentSlide].title4}</h4>
              <p className="text-black text-sm sm:text-base lg:text-xl font-medium text-center px-6 mb-12 sm:px-32 md:px-40 lg:px-56 xl:px-96">{slides[currentSlide].description}</p>
              <div className="flex  flex-row sm:flex-row gap-7 justify-center mb-16 ">
                ...
                <Link href={slides[currentSlide].href1}>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center">
                <button onClick={goToNextSlide} className="bg-gray-300 text-gray-800 rounded-full w-10 h-10 focus:outline-none lg:w-12 lg:h-12">
                  &gt;
                </button>
              </div>
            </div>
        ...
        <div className="">
          <div className="container mx-auto gap-5 flex flex-col lg:gap-5 lg:flex-row items-center justify-between">
            ...
            <div className="flex-1 lg:order-3 lg:h-700 lg:w-470 bg-gray py-6 px-6 2xl:h-[700px] 2xl:py-6 xl:py-3 xl:h-[568px] lg:h-[443px] ">
              ...
              <p className="pb-5 text-sm sm:text-lg lg:text-sm lg:pb-1">Welcome to Transcode Solutions – where innovation meets excellence.</p>
          ...
          <div className="container mx-auto gap-20 mt-10 text-center p-2">
            ...
            <div className="bg-gray sm:mb-16 p-2">
              ...
              <div className="gap-1 lg:flex items-center 	">
                {/* <div className=" "> */}
                <div className="">
                  <Image src={workProcess} alt="workProcess" className="object-contain w-[570px] h-[100%]" />
                </div>
                {/* </div> */}
                <div className="">
                  <div className="">
                    <Image src={Process} alt="Process" className="object-contain w-[470px] h-[100%]" />
                  </div>
                </div>
              </div>             
            </div>
            <div className="my-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 mt-28">
                <div className="relative border-2 border-blue rounded-3xl text-left p-4 md:p-6 xl:p-10">
                  <div className="" >
                ...
                <div className="relative border-2 border-blue rounded-3xl text-left p-4 md:p-6 xl:p-10 mt-20 sm:mt-0">
                  <div className="">
                ...
                <div className="relative border-2 border-blue rounded-3xl text-left p-4 md:p-6 xl:p-10 mt-20 lg:mt-0 sm:mt-40">
                  <div className="">
