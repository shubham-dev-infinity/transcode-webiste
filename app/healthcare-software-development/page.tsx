        ...
        <main>
            ...
            <div className="container mx-auto mt-12">
                <div className="text-center mb-4 sm:mb-12">
                    ...
                    <Link href="/contact-us" className="bg-blue px-4 py-2 rounded-md font-bold text-white lg:mb-0 hover:bg-white hover:text-blue hover:shadow-2xl">Contact Us</Link>
