        ...
        <main className="mb-20">
            ...
            <div className="container mx-auto my-10 p-4">
                <div className={styles.BgImage}>
                    <div className="grid grid-cols-12 gap-8 mb-8 p-6">
                ...
                <div className="grid grid-cols-12 gap-8 mb-8">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <h2 className="text-blue font-extrabold text-3xl pt-8">PROBLEMS IN THE WORLD</h2>
                ...
                <div className="grid grid-cols-12 gap-8 mb-8">
                    <div className="col-span-12 md:col-span-6">
                        <h2 className="text-blue font-extrabold text-3xl pt-20">OPPORTUNITIES</h2>
                ...
                <div className="grid grid-cols-12 gap-8 mb-8">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <h2 className="text-blue font-extrabold text-3xl py-8">MY PAST EXPERIENCES</h2>
